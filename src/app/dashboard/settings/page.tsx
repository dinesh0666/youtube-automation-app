  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-zinc-400 mt-2">Configure your workspace, channels, and automation</p>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-12 text-center">
        <div className="max-w-md mx-auto space-y-4">
          ...
          <p className="text-sm text-zinc-500">
            Configure YouTube OAuth, manage multiple channels, set pipeline preferences, update API keys, and customize automation workflows.
          </p>
        </div>
      </div>
    </div>
